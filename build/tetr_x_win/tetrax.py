...
class Game:
    ...
    def __init__(self):
        ...
        self.played_sounds = []
        # self.play_sound()
        pygame.mixer.Channel(0).play(pygame.mixer.Sound("intro.mp3")) 
        ...
        if not sound in self.played_sounds:
            if sound == "1":
                ...
                pygame.mixer.Channel(0).play(
                    pygame.mixer.Sound("level_1.mp3"), loops=4) 
            elif sound == "2":
                self.played_sounds.append("2")
                pygame.mixer.Channel(0).play(
                    pygame.mixer.Sound("level_2.mp3"), loops=4) 
            elif sound == "3":
                self.played_sounds.append("3")
                pygame.mixer.Channel(0).play(
                    pygame.mixer.Sound("level_3.mp3"), loops=4)
            elif sound == "4":
                self.played_sounds.append("4")
                pygame.mixer.Channel(0).play(
                    pygame.mixer.Sound("level_4.mp3"), loops=4) 
            elif sound == "5":
                self.played_sounds.append("5")
                pygame.mixer.Channel(0).play(
                    pygame.mixer.Sound("level_5.mp3"), loops=4)
            return
        else:
            self.play_sound()
    ...
    def load_title_image(self):
        image = randint(1, 8)
        if image == 1:
            return pygame.image.load("title_col_1.png")
        elif image == 2:
            return pygame.image.load("title_col_2.png")
        elif image == 3:
            return pygame.image.load("title_col_3.png")
        elif image == 4:
            return pygame.image.load("title_col_4.png")
        elif image == 5:
            return pygame.image.load("title_col_5.png")
        elif image == 6:
            return pygame.image.load("title_col_6.png")
        elif image == 7:
            return pygame.image.load("title_col_7.png")
        elif image == 8:
            return pygame.image.load("title_col_8.png")
    ...
    def lock_tile(self):
        ...
        pygame.mixer.Channel(1).play(pygame.mixer.Sound("lock.mp3")) 
    ...
    def check_max_heigth(self):
        ...
        for block in self.static_blocks:
            if block.rect.y <= 0:
                pygame.mixer.Channel(0).play(
                    pygame.mixer.Sound("gameover.mp3")) 
    ...
    def check_win(self):
        ...
        if (
            ...
            pygame.mixer.Channel(1).play(
                pygame.mixer.Sound("newrecord.mp3"))
            return
    ...
    def move_right(self):
        ...
        pygame.mixer.Channel(6).play(pygame.mixer.Sound("beep.mp3")) 
    ...
    def turn_right(self):
        ...
        if right_turn_possible:
            ...
            pygame.mixer.Channel(2).play(pygame.mixer.Sound("turnr.mp3")) 
    ...
    def turn_left(self):
        ...
        if left_turn_possible:
            ...
            pygame.mixer.Channel(2).play(pygame.mixer.Sound("turnl.mp3")) 
    ...
    def play_linesound(self):
        if self.tetrx_counter > 0 and self.tetrx_counter < 4:
            pygame.mixer.Channel(4).play(
                pygame.mixer.Sound("linedown.mp3"))
                
        if self.tetrx_counter == 4:
            pygame.mixer.Channel(4).play(
                pygame.mixer.Sound("tetrx.mp3"))
